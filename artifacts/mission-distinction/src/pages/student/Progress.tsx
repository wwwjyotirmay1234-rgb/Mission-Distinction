...
import { Clock, FileText, CheckCircle, Flame, Trophy, BookOpen, Download, MessageSquare, Timer, Bookmark, Brain, Users, MessageCircle, Lightbulb } from "lucide-react";
    ...
    <div className="space-y-4 sm:space-y-6">
        ...
        <CardContent className="p-6 relative">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-base flex items-center gap-2">
              <span className="text-lg">⚽</span> Goals & Rank
            </h3>
          ...
          <div className="mt-5 pt-4 border-t border-border/30">
            <p className="text-xs font-semibold text-muted-foreground mb-3">How to score Goals ⚽</p>
            ...
            return (
              ...
              >
                ...
                <p className="text-[10px] text-muted-foreground mt-0.5">
                  {rank.min === 0 ? "Start" : rank.min.toLocaleString() + " Goals"}
                </p>
                {unlocked && (
      ...
      {xpStats?.recentHistory && xpStats.recentHistory.length > 0 && (
        <Card className="bg-card/40 border-border/40">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-semibold flex items-center gap-2">
              <span className="text-sm">⚽</span> Recent Goals Activity
            </CardTitle>
          </CardHeader>
            ...
            <div className="divide-y divide-border/40">
              {xpStats.recentHistory.slice(0, 8).map(tx => (
                <div key={tx.id} className="flex items-center gap-3 px-4 py-2.5">
                  <div className="w-7 h-7 rounded-full bg-primary/10 flex items-center justify-center shrink-0 text-sm">
                    ⚽
                  </div>
