...
export const RANKS: Rank[] = [
  ...
  },
  {
    ...
    max: null,
    color: "#ffd700",
    bgClass: "bg-gradient-to-r from-yellow-500/10 via-amber-500/10 to-green-500/10",
    textClass: "text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-amber-400 to-green-400",
