      ...
      <div className={cn("flex items-center shrink-0 border-b border-sidebar-border", isCollapsed ? "justify-center py-4 px-2" : "px-4 py-4 gap-3")}>
        {!isCollapsed && (
          <>
            <div className="relative shrink-0">
              <img src={`${import.meta.env.BASE_URL}md-logo-new.png`} alt="Mission Distinction" className="h-8 w-8 object-contain rounded-lg" />
            </div>
        ...
        {isCollapsed && (
          <div className="relative">
            <img src={`${import.meta.env.BASE_URL}md-logo-new.png`} alt="Mission Distinction" className="h-7 w-7 object-contain rounded-lg" />
          </div>
        )}
