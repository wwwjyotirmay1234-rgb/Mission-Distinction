  ...
  return (
    ...
    >
      ...
      {Array.from({ length: 18 }).map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            left: `${8 + (i * 29 % 84)}%`,
            top: `${10 + (i * 37 % 80)}%`,
            backgroundColor: i % 2 === 0 ? 'rgba(200,163,64,0.3)' : 'rgba(124,58,237,0.3)',
          }}
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-[5vw]">
        ...
        >
          <p className="text-[1vw] font-sans tracking-[0.2em] uppercase" style={{ color: 'rgba(255,255,255,0.25)' }}>
